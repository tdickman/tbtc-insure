    ...
    <div>
      ...
      <Container>
        <div style={{
          ...
          <p style={{textAlign: 'center'}}>By clicking connect you agree to the terms listed under the about tab. Please make sure you have metamask installed and set to mainnet.</p>
        </div>
      </Container>)}
